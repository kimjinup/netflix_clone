...
interface ITvOveralyProps {
  basePath: string;
  tvShow: ITvShow;
  category: string;
}
const TvOverlay = ({ basePath, tvShow, category }: ITvOveralyProps) => {
  ...
  return (
    <>
      ...
      >
        {tvShow && (
          <>
            <BigCover bgPath={tvShow.backdrop_path || ""} />
            <BigTitle>{tvShow.original_name}</BigTitle>
